...
def sample_params():
    ...
    flocking_density = random.uniform(0.2, 15)
    flocking_velocity = random.uniform(0.01, 0.5)
    ...
    return FlockingParams(
        ...
        flocking_velocity=flocking_velocity,
        light_1=light_1,
        light_2=light_2,
...
def get_mission(params: FlockingParams = FlockingParams()):
    ...
    objective = ObjFlocking(density=params.flocking_density,
                            velocity=params.flocking_velocity)
